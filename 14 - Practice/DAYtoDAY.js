...
console.log(`Ooct  01th     All 9ª Reunion and Mt 10ª class`)
console.log(`Ooct  02th     Evoid class with MT 11º`)
console.log(`Ooct  03th     Simple day i fuck with M&M`)
console.log(`Ooct  04th     Rest day and no more....`)
console.log(`Ooct  05th     REST... HOME... `)
console.log(`Ooct  06th      `)
