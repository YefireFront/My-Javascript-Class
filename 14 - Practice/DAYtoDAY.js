...
console.log(`June  05th   Bad Notice about my little girl Alana`)
...
console.log(`June  15th   In the Alanas examn dopler, she is okay... CC birthday, i dont know whether to go, i can `) 
...
console.log(`July  12th    Star`) 
console.log(`July  13th    2`) 
console.log(`July  14th    3`) 
...
console.log(`Sept  02th     I did not quote the students in the lab and relaxed in the room remembering to react`) 
console.log(`Sept  03th     Explaing MT how it the rest of the time `) 
console.log(`Sept  04th     Class with MAT and VAL BD advance`) 
console.log(`Sept  05th     MY QUEEN LEAVE ME`) 
...
console.log(`Sept  11th     BD examan about simple topic... create a Sistem room BD`) 
console.log(`Sept  12th     PARO NACIONAL`) 
console.log(`Sept  13th     The POA Call me an invited me to drink, and i fell`) 
console.log(`Sept  14th     Drinking 🍻`) 
console.log(`Sept  15th     Organize idea abou video game`) 
console.log(`Sept  16th     The coorD make go to the collage to cover the sena teacher`) 
console.log(`Sept  17th     Function and Array class for the MT`) 
console.log(`Sept  18th     10 minute exame and leave the collage to relax.. and enjoy when i came my hoise`) 
console.log(`Sept  19th     RPG GAME BEST MODE`) 
console.log(`Sept  20th     RPG GAME BEST MODE`) 
console.log(`Sept  21th     RPG GAME BEST MODE`) 
console.log(`Sept  22th     RPG GAME BEST MODE`) 
console.log(`Sept  23th     RPG GAME BEST MODE`) 
console.log(`Sept  24th     RPG GAME BETS MODE`) 
console.log(`Sept  25th     Show the game to MT `) 
console.log(`Sept  26th     Proect esposicion  and my words`) 
...
console.log(`Octo  01th     All 9ª Reunion and Mt 10ª class`)
console.log(`Octo  02th     Evoid class with MT 11º`)
console.log(`Octo  03th     Simple day i fuck with M&M`)
...
console.log(`Octo  12th     MY DAD is home `)   
...
console.log(`Octo  19th     Summonner Wars Day`)
console.log(`Octo  20th     MT CLass Video Game importan day `)
console.log(`Octo  21th     5AM AGAIN`)
console.log(`Octo  22th     MT 10º Final Exam`)
...
console.log(`Octo  28th     Ultimate Detail VIDEO GAME `)
...
console.log(`Novb  01th     Personal Pro ULTIMATE DETAIL FINAL PULL VIDEO GAME`)
console.log(`Novb  02th     🍹`)
console.log(`Novb  03th     🍹🍹`)
console.log(`Novb  04th     Back home a rest`)
console.log(`Novb  05th     MT 10 Final Maquet exam `)
console.log(`Novb  06th     evoid the school PARO`)
console.log(`Novb  07th     Prepare examen  9`)
console.log(`Novb  08th     `)
console.log(`Novb  09th     🍹`)
console.log(`Novb  10th     🍹`)
console.log(`Novb  11th     Reset my mind`)
console.log(`Novb  12th     THE OPORTUNITY OF MY LIFE, ALL CAN CHANGE I NEED YOUN GOD 🙏, PLEASE DONT FORGET ME 💙`)
console.log(`Novb  13th     Feria Creatividad`)
console.log(`Novb  14th     Un 14 de noviembre Inicia un gran deseo`)
console.log(`Novb  15th     A prayer `)
...
console.log(`Novb  25th     English class retaked`)
console.log(`Novb  26th     English class retaked`)
console.log(`Novb  27th     English class retaked`)
console.log(`Novb  28th     English class retaked`)
console.log(`Novb  29th     English class retaked`)
console.log(`Novb  30th     English class retaked`)
