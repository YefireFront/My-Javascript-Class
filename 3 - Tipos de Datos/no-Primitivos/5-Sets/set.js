...
const carBrandsSet = new Set(['Toyota', 'Ford', 'Honda', 'Chevrolet', 'BMW']);
carBrandsSet.add('Tesla');
carBrandsSet.add('Ford');
carBrandsSet.delete('Chevrolet');
console.log(carBrandsSet.has('BMW'));
console.log(carBrandsSet.has('Chevrolet'));
const carBrandsArray = [...carBrandsSet];
console.log(carBrandsArray);